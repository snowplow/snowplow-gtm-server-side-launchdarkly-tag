...

{
  ...
  "version": 1,
  "securityGroups": [],
  "displayName": "Launch Darkly Metric Events",
  "brand": {
  ...
  "description": "Tag that sends events to Launch Darklys Metric Events API from Snowplow, GAv4 or other clients. Works best with the Snowplow Client.",
  "containerContexts": [
    "SERVER"
  ]
}
  ...
  },
  {
    ...
    "subParams": [
      ...
      },
      {
        ...
        "simpleValueType": true,
        "help": "Used to help Launch Darkly identify the source of traffic and debug issues.",
        "valueValidators": [
          {
            "type": "NON_EMPTY"
          }
